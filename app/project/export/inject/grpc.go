...
import (
	...
	grpc2 "projectforge.dev/projectforge/app/project/export/files/grpc"
...
func GRPC(f *file.File, args *model2.Args) error {
	if len(args.Models) == 0 {
		return nil
	}
	out := make([]string, 0, len(args.Models)*6)
	for _, m := range args.Models {
		fileArgs, err := grpc2.GetGRPCFileArgs(m, args)
		if err != nil {
...
func grpcAll(m *model2.Model, fa *grpc2.FileArgs) []string {
...
func grpcList(m *model2.Model, fa *grpc2.FileArgs) string {
...
func grpcSearch(m *model2.Model, fa *grpc2.FileArgs) string {
...
func grpcDetail(m *model2.Model, fa *grpc2.FileArgs) string {
...
func grpcCreate(m *model2.Model, fa *grpc2.FileArgs) string {
...
func grpcUpdate(m *model2.Model, fa *grpc2.FileArgs) string {
...
func grpcSave(m *model2.Model, fa *grpc2.FileArgs) string {
...
func grpcDelete(m *model2.Model, fa *grpc2.FileArgs) string {
