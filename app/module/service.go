...
var nativeModuleKeys = []string{
	...
	"filesystem", "git", "graphql", "har", "help", "ios", "jsx", "marketing", "migration", "metamodel", util.DatabaseMySQL,
	"notebook", "notarize", "numeric", "oauth", "openapi", "playwright", util.DatabasePostgreSQL, "process", "proxy", "queue",
