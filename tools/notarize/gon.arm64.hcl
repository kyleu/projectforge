...
notarize {
  path = "./build/dist/projectforge_0.11.11_darwin_arm64_desktop.dmg"
  bundle_id = "com.kyleu.projectforge"
}
...
dmg {
  output_path = "./build/dist/projectforge_0.11.11_darwin_arm64.dmg"
  volume_name = "Project Forge"
}

zip {
  output_path = "./build/dist/projectforge_0.11.11_darwin_arm64_notarized.zip"
}
