...
notarize {
  path = "./build/dist/projectforge_1.0.15_darwin_arm64_desktop.dmg"
  bundle_id = "com.kyleu.projectforge"
}
...
dmg {
  output_path = "./build/dist/projectforge_1.0.15_darwin_arm64.dmg"
  volume_name = "Project Forge"
}

zip {
  output_path = "./build/dist/projectforge_1.0.15_darwin_arm64_notarized.zip"
}
