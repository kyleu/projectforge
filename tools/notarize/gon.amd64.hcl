...
notarize {
  path = "./build/dist/projectforge_1.0.12_darwin_amd64_desktop.dmg"
  bundle_id = "com.kyleu.projectforge"
}
...
dmg {
  output_path = "./build/dist/projectforge_1.0.12_darwin_amd64.dmg"
  volume_name = "Project Forge"
}

zip {
  output_path = "./build/dist/projectforge_1.0.12_darwin_amd64_notarized.zip"
}
