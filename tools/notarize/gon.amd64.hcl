...
//notarize {
//  path = "./build/dist/projectforge_0.1.27_macos_x86_64_desktop.dmg"
//  bundle_id = "com.kyleu.projectforge"
//}
...
dmg {
  output_path = "./build/dist/projectforge_0.1.27_macos_x86_64.dmg"
  volume_name = "Project Forge"
}

zip {
  output_path = "./build/dist/projectforge_0.1.27_macos_x86_64_notarized.zip"
}
