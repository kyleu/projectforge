...
create index if not exists "audit_record__audit_id_idx" on "audit_record" ("audit_id");{{{ else }}}
create table if not exists "audit" (
  "id" uuid not null,
  "app" text not null,
  "act" text not null,
...
create index if not exists "audit_record__audit_id_idx" on "audit_record" ("audit_id");{{{ end }}}{{{ end }}}
-- {% endfunc %}
