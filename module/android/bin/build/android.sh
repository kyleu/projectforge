...
##
## Outputs:
##   - build/dist/{{{ .Key }}}_<version>_android_aar.zip
##   - build/dist/{{{ .Key }}}_<version>_android_apk.zip
...
echo "Output written to [./build/dist/{{{ .Key }}}_${TGT}_android_aar.zip] and [./build/dist/{{{ .Key }}}_${TGT}_android_apk.zip]"
