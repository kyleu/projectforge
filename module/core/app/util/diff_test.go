...
var diffTests = []struct {
	...
	{k: "bool.different", l: true, r: false, d: util.Diffs{&util.Diff{Old: "true", New: "false"}}},
	...
	{k: "map.missing", l: testObj, r: util.ValueMap{"y": true}, d: util.Diffs{&util.Diff{Path: ".x", Old: "map[y:1]", New: ""}, {Path: ".y", Old: "", New: "true"}}},
	{k: "map.extra", l: testObj, r: util.ValueMap{"x": util.ValueMap{"y": 1, "z": true}}, d: util.Diffs{&util.Diff{Path: ".x.z", Old: "", New: "true"}}},
	{k: "array.same", l: testArr, r: testArr, d: util.Diffs{}},
	{k: "array.different", l: testArr, r: []interface{}{"y", 2, true}, d: util.Diffs{&util.Diff{Path: ".0", Old: "x", New: "y"}, {Path: ".1", Old: "1", New: "2"}}},
	{k: "array.missing", l: testArr, r: []interface{}{"x", 1}, d: util.Diffs{&util.Diff{Path: ".2", Old: "true", New: ""}}},
	{k: "array.extra", l: testArr, r: []interface{}{"x", 1, true, "new"}, d: util.Diffs{&util.Diff{Path: ".3", Old: "", New: "new"}}},
}
