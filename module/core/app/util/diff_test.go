...
var diffTests = []struct {
	...
	{k: "bool.different", l: true, r: false, d: util.Diffs{{Old: "true", New: "false"}}},
	{k: "int.same", l: 1, r: 1, d: util.Diffs{}},
	{k: "int.different", l: 1, r: 10, d: util.Diffs{{Old: "1", New: "10"}}},
	{k: "string.same", l: "x", r: "x", d: util.Diffs{}},
	{k: "string.different", l: "x", r: "y", d: util.Diffs{{Old: "x", New: "y"}}},
	{k: "map.same", l: testObj, r: testObj, d: util.Diffs{}},
	{k: "map.different", l: testObj, r: util.ValueMap{"x": util.ValueMap{"y": 2}}, d: util.Diffs{{Path: ".x.y", Old: "1", New: "2"}}},
	{k: "map.missing", l: testObj, r: util.ValueMap{"y": true}, d: util.Diffs{{Path: ".x", Old: "map[y:1]", New: ""}, {Path: ".y", Old: "", New: "true"}}},
	{k: "map.extra", l: testObj, r: util.ValueMap{"x": util.ValueMap{"y": 1, "z": true}}, d: util.Diffs{{Path: ".x.z", Old: "", New: "true"}}},
	{k: "array.same", l: testArr, r: testArr, d: util.Diffs{}},
	{k: "array.different", l: testArr, r: []interface{}{"y", 2, true}, d: util.Diffs{{Path: ".0", Old: "x", New: "y"}, {Path: ".1", Old: "1", New: "2"}}},
	{k: "array.missing", l: testArr, r: []interface{}{"x", 1}, d: util.Diffs{{Path: ".2", Old: "true", New: ""}}},
	{k: "array.extra", l: testArr, r: []interface{}{"x", 1, true, "new"}, d: util.Diffs{{Path: ".3", Old: "", New: "new"}}},
}
