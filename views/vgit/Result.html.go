...
//line views/vgit/Result.html:34
	streamstatusDetail(qw422016, p.Result, ps)
//line views/vgit/Result.html:34
	qw422016.N().S(`
  </div>
`)
...
func streamstatusDetail(qw422016 *qt422016.Writer, r *git.Result, ps *cutil.PageState) {
//line views/vgit/Result.html:47
	qw422016.N().S(`
...
//line views/vgit/Result.html:114
			view.StreamURL(qw422016, "/p/"+r.Project+"/fs/"+d, d, false, ps)
//line views/vgit/Result.html:114
			qw422016.N().S(`</li>
`)
...
//line views/vgit/Result.html:134
func writestatusDetail(qq422016 qtio422016.Writer, r *git.Result, ps *cutil.PageState) {
//line views/vgit/Result.html:134
	qw422016 := qt422016.AcquireWriter(qq422016)
//line views/vgit/Result.html:134
	streamstatusDetail(qw422016, r, ps)
//line views/vgit/Result.html:134
	qt422016.ReleaseWriter(qw422016)
//line views/vgit/Result.html:134
}
...
//line views/vgit/Result.html:134
func statusDetail(r *git.Result, ps *cutil.PageState) string {
//line views/vgit/Result.html:134
	qb422016 := qt422016.AcquireByteBuffer()
//line views/vgit/Result.html:134
	writestatusDetail(qb422016, r, ps)
//line views/vgit/Result.html:134
	qs422016 := string(qb422016.B)
//line views/vgit/Result.html:134
	qt422016.ReleaseByteBuffer(qb422016)
