...
//line views/components/view/JSONSchema.html:10
import (
	qtio422016 "io"
...
//line views/components/view/JSONSchema.html:14
		switch t := v.(type) {
//line views/components/view/JSONSchema.html:15
		case string:
//line views/components/view/JSONSchema.html:16
			qw422016.E().S(t)
//line views/components/view/JSONSchema.html:17
		case *jsonschema.Schema:
//line views/components/view/JSONSchema.html:18
			StreamJSONSchema(qw422016, t, full, ps)
//line views/components/view/JSONSchema.html:19
		case *util.OrderedMap[*jsonschema.Schema]:
//line views/components/view/JSONSchema.html:20
			if t.Length() == 0 {
//line views/components/view/JSONSchema.html:20
				qw422016.N().S(`<em>-</em>`)
...
//line views/components/view/JSONSchema.html:25
					itemKey := util.RandomString(16)

//line views/components/view/JSONSchema.html:26
					x := t.GetSimple(k)

//line views/components/view/JSONSchema.html:26
					qw422016.N().S(`<li><input id="accordion-`)
//line views/components/view/JSONSchema.html:28
					qw422016.E().S(itemKey)
//line views/components/view/JSONSchema.html:28
					qw422016.N().S(`" type="checkbox" hidden /><label for="accordion-`)
//line views/components/view/JSONSchema.html:29
					qw422016.E().S(itemKey)
//line views/components/view/JSONSchema.html:29
...
//line views/components/view/JSONSchema.html:30
					qw422016.N().S(`</em></div>`)
//line views/components/view/JSONSchema.html:31
...
//line views/components/view/JSONSchema.html:33
						qw422016.N().S(` `)
//line views/components/view/JSONSchema.html:33
						components.StreamSVGRef(qw422016, "gift", 16, 16, "icon", ps)
//line views/components/view/JSONSchema.html:33
						qw422016.N().S(` `)
...
//line views/components/view/JSONSchema.html:46
		case *util.OrderedMap[bool]:
//line views/components/view/JSONSchema.html:47
			if t.Length() == 0 {
//line views/components/view/JSONSchema.html:47
				qw422016.N().S(`<em>-</em>`)
//line views/components/view/JSONSchema.html:49
			} else {
//line views/components/view/JSONSchema.html:51
				ret := util.NewStringSlice()
				for _, k := range t.Keys() {
					ret.Push(k + ": " + fmt.Sprint(t.GetSimple(k)))
				}

//line views/components/view/JSONSchema.html:56
				qw422016.E().S(ret.Join(", "))
//line views/components/view/JSONSchema.html:57
			}
...
//line views/components/view/JSONSchema.html:62
}
...
//line views/components/view/JSONSchema.html:64
	qw422016.N().S(`
  `)
//line views/components/view/JSONSchema.html:65
	if !omit {
//line views/components/view/JSONSchema.html:65
		qw422016.N().S(`
  <tr>
...
//line views/components/view/JSONSchema.html:93
	qw422016.N().S(`
        `)
//line views/components/view/JSONSchema.html:94
...
//line views/components/view/JSONSchema.html:161
	qw422016.N().S(`
        ...
        `)
//line views/components/view/JSONSchema.html:163
...
`)
//line views/components/view/JSONSchema.html:168
}
